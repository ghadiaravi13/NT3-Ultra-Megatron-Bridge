...
def nemotron_3_ultra_pretrain_config() -> ConfigContainer:
    ...
    # --moe-flex-dispatcher-backend hybridep). Keep the matching performance
    # workload base config in sync: PerfEnvPlugin uses that head-node-safe config
    # to derive NVLink domain, MNNVL, ranks/domain, and combine chunk size.
